...
const DAYS = {
  ...
  7: [P.henningsvaer, P.haukland, P.uttakleiv],
  8: [P.uttakleiv, P.fredvang],
  9: [P.fredvang, P.reine, P.aa, P.nusfjord, P.moskenes],
  10: [P.moskenes, P.bodoe, P.saltstraumen, P.mosjoen],
  11: [P.mosjoen, P.trondheim],
  12: [P.trondheim, P.kristiansund, P.atlanterhavsvegen, P.molde],
